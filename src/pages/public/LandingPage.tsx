    ...
    >
      ...
      <header className="sticky top-0 z-40 w-full border-b border-slate-200/80 bg-white/90 backdrop-blur-md dark:border-slate-800/80 dark:bg-[#080D1A]/90 transition-colors">
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-3.5 sm:px-6 lg:px-8">
          ...
          >
            <div className="flex h-11 w-11 sm:h-12 sm:w-12 items-center justify-center rounded-2xl bg-gradient-to-tr from-amber-500/20 via-yellow-500/10 to-amber-300/20 p-2 border border-amber-400/40 shadow-sm shadow-amber-500/15 group-hover:scale-105 transition-transform duration-200">
              <img
                src={lumosLogo}
            ...
            <div>
              <div className="flex items-center gap-1.5">
                <span className="text-lg sm:text-xl font-black tracking-tight text-slate-900 dark:text-white font-serif">
                  LUMOS
                </span>
                <span className="h-1.5 w-1.5 rounded-full bg-amber-500" />
              </div>
              <span className="block text-[9px] sm:text-[10px] uppercase tracking-widest text-amber-600 dark:text-amber-400 font-extrabold -mt-0.5">
                O‘quv Markazi
              </span>
            </div>
          </div>
          ...
          <nav className="hidden lg:flex items-center gap-7 text-xs font-bold text-slate-600 dark:text-slate-300">
            ...
            >
              {t.landing.navCourses}
            </a>
            <a
              href="#teachers"
              className="hover:text-amber-600 dark:hover:text-amber-400 transition-colors py-1 px-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800/50"
            >
              {t.landing.navTeachers}
            </a>
            <a
              href="#why-us"
              className="hover:text-amber-600 dark:hover:text-amber-400 transition-colors py-1 px-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800/50"
          ...
          {/* Right Controls: Theme + Language (md+) + Portal CTA (lg+) + Mobile Hamburger (lg hidden) */}
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {/* Language Switcher (Hidden on mobile < md, visible on tablet/desktop) */}
            <div className="hidden md:flex items-center rounded-xl border border-slate-200 bg-slate-50 p-0.5 text-[11px] font-black dark:border-slate-800 dark:bg-slate-900/90">
            ...
            <div className="hidden lg:flex items-center">
              ...
              >
                <span>
                  {currentUser
                    ? currentRole === 'student'
                      ? t.landing.returnToStudentCabinet
            ...
            <button
              ...
              className={`flex lg:hidden h-10 w-10 items-center justify-center rounded-xl border transition-all cursor-pointer ${
                isMobileMenuOpen
                  ...
                  : 'border-slate-200/80 bg-slate-50 text-slate-700 hover:bg-slate-100 dark:border-slate-800 dark:bg-slate-900/90 dark:text-slate-200 dark:hover:bg-slate-800'
              }`}
              aria-label="Menyu"
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden border-t border-slate-200/80 bg-white/98 backdrop-blur-2xl dark:border-slate-800/80 dark:bg-[#080D1A]/98 px-4 sm:px-6 py-5 space-y-4 shadow-2xl animate-in slide-in-from-top-2 duration-200">
            {/* 1. Mobile Language Selector */}
      ...
      <section id="stats" className="border-y border-slate-200/80 bg-white py-10 sm:py-12 dark:border-slate-800/80 dark:bg-slate-900/60 transition-colors">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 gap-4 sm:gap-6 lg:grid-cols-4">
            ...
            <div className="text-center space-y-1">
              <span className="text-3xl sm:text-4xl font-black text-blue-500 font-mono">2</span>
              <p className="text-xs font-bold text-slate-600 dark:text-slate-400">
                {t.landing.specializedTracks}
              </p>
            </div>
            <div className="text-center space-y-1">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 max-w-5xl mx-auto">
            {INITIAL_COURSES.map((course) => {
              ...
              const courseTitle = isMath ? t.landing.mathTitle : t.landing.engTitle;
              const courseDesc = isMath ? t.landing.mathDesc : t.landing.engDesc;
              const teacherName = isMath ? t.landing.mathTeacherName : t.landing.engTeacherName;
              const courseSchedule = isMath ? t.landing.mathSchedule : t.landing.engSchedule;
              const courseBadge = isMath ? t.landing.mathBadge : t.landing.engBadge;
              const syllabusItems = isMath ? t.landing.mathSyllabus : t.landing.engSyllabus;
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 max-w-4xl mx-auto">
            ...
            <div className="rounded-2xl sm:rounded-3xl border border-slate-200/90 bg-white p-5 sm:p-8 shadow-sm dark:border-slate-800 dark:bg-slate-900 space-y-6 flex flex-col justify-between">
              <div className="space-y-4 sm:space-y-5">
                ...
                <div className="rounded-2xl bg-slate-50 dark:bg-slate-800/50 p-3.5 border border-slate-100 dark:border-slate-800 text-xs space-y-1.5">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-semibold text-slate-800 dark:text-slate-200 text-[11px] sm:text-xs">{t.landing.hadichaTime}</span>
                  </div>
                </div>
              </div>
              ...
              <Button
                ...
                onClick={() => {
                  setSelectedCourseName(t.landing.mathTitle);
                  setIsApplyModalOpen(true);
                }}
              >
            ...
            <div className="rounded-2xl sm:rounded-3xl border border-slate-200/90 bg-white p-5 sm:p-8 shadow-sm dark:border-slate-800 dark:bg-slate-900 space-y-6 flex flex-col justify-between">
              <div className="space-y-4 sm:space-y-5">
                ...
                <div className="rounded-2xl bg-slate-50 dark:bg-slate-800/50 p-3.5 border border-slate-100 dark:border-slate-800 text-xs space-y-1.5">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-slate-500">{t.landing.timeLabel}:</span>
                    <span className="font-semibold text-slate-800 dark:text-slate-200 text-[11px] sm:text-xs">{t.landing.hasanboyTime}</span>
                  </div>
                </div>
              </div>
              ...
              <Button
                ...
                className="w-full justify-center gap-2 font-bold cursor-pointer rounded-xl py-2.5"
                onClick={() => {
                  setSelectedCourseName(t.landing.engTitle);
                  setIsApplyModalOpen(true);
                }}
              >
            ...
            <div className="rounded-2xl sm:rounded-3xl border border-slate-200/90 bg-white p-5 sm:p-8 shadow-xl dark:border-slate-800 dark:bg-slate-900">
              ...
              <form onSubmit={handleApplySubmit} className="space-y-4">
                ...
                <Select
                  ...
                  options={[
                    { value: t.landing.mathTitle, label: t.landing.mathTitle },
                    { value: t.landing.engTitle, label: t.landing.engTitle },
                  ]}
                />
      ...
      <footer className="border-t border-slate-200 bg-white py-12 dark:border-slate-800 dark:bg-slate-950 transition-colors">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <p className="text-xs text-slate-400 text-center sm:text-right">
            © {new Date().getFullYear()} LUMOS ERP & Education. {t.landing.footerRights}
          </p>
        </div>
      </footer>
