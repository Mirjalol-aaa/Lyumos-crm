...
export const AdminTeacherLogin: React.FC<AdminTeacherLoginProps> = ({ onSwitchToStudent, onBackToHome }) => {
  ...
  return (
    <div className="dark min-h-screen w-full flex flex-col lg:flex-row bg-[#070C18] font-sans antialiased text-slate-100 selection:bg-amber-500 selection:text-white">
      ...
      <div className="relative hidden lg:flex lg:w-1/2 min-h-screen bg-[#050811] overflow-hidden items-end p-12">
        <img
          src="https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&q=80&w=1600"
          alt="LUMOS Education Center"
          className="absolute inset-0 h-full w-full object-cover opacity-50 scale-105"
        />
        <div className="absolute inset-0 bg-gradient-to-t from-[#070C18] via-[#070C18]/70 to-transparent" />
      ...
      <div className="flex-1 flex flex-col justify-between p-6 sm:p-12 lg:p-16 max-w-xl mx-auto w-full bg-[#070C18]">
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="text-xs font-bold text-blue-300 hover:text-blue-200 flex items-center gap-1.5 cursor-pointer bg-blue-950/70 px-3.5 py-2 rounded-xl border border-blue-800 hover:border-blue-700 transition-all shadow-xs"
            >
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              <label className="text-xs font-bold text-slate-200 block mb-1.5">
                <span className="text-rose-400 font-black">*</span> Login
              </label>
              <input
                type="text"
                required
