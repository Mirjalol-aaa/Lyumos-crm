      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-slate-400">Jami {branches.length} ta markaz</span>
          </div>
          <h1 className="mt-1 text-xl sm:text-2xl font-black tracking-tight text-slate-900 dark:text-[#F8F4EA] font-serif">
            Lumos Markazlari (Filiallar)
          </h1>
          <p className="text-xs text-slate-500 dark:text-[#9D958C]">
            Lumos o‘quv markazlari tarmog‘ining barcha filiallari, mas’ul adminlari, sig‘imi va holati.
          </p>
        </div>
